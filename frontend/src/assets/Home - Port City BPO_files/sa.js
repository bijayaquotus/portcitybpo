(function() {
    ...
    var config = {
            ...
            wonderpush_webkey: '30de804fbed3a3339bcbd7e0a7b4a0e7a159564deec99353ec7cf796cce3a58a',
        },
        Helper = new hl();
    var iframe,cm;
    function q() {
